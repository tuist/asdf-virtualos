...
GH_REPO="https://github.com/tuist/macker"
TOOL_NAME="macker"
TOOL_TEST="macker --help"
...
list_all_versions_sorted() {
	...
	# Change this function if macker has other means of determining installable versions.
	list_github_tags_sorted
}
...
download_release() {
	...
	url="$GH_REPO/releases/download/${version}/macker.zip"
...
install_version() {
	...
	(
		...
		# TODO: Assert macker executable exists.
		local tool_cmd
